...
- This repository is a frontend client only.
- The TaskFlow API backend must run separately for live API mode.
- Demo mode uses MSW and fake data for frontend review without backend.
- Demo mode does not replace final live integration testing.
